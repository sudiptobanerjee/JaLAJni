...
public final class lapacktest {
    ...
    public static void main(String[] args) {
        ...
        //
        System.out.println("###   Testfile for jama_lite jni_lapack   ### \n \n");
        int M=3, N=3, K=3;
        int[] info = new int[]{0};
	...
	int lda = N; // lda is the leading dimension of the array a, here since it is row-major, lda >= max(1, n)
	...
	//lda = the leading dimension of the array a, here since it is row_major, lda >= max(1, n)
	...
	n = M; // n = the order of the matrix a
	...
	jniLAPACK.dggev(matrix_layout, jobvl, jobvr, n, a, lda, b, ldb, alphar, alphai, beta, vl, ldvl, vr, ldvr, work, lwork, info);
